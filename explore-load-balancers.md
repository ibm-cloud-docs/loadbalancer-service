...
|**Horizontal Scaling**|![Checkmark icon](../../icons/checkmark-icon.svg)|No|No|
...
|**Advance LB (TCP Optimization, Compress, Caching, WAF)**|No|Limited|![Checkmark icon](../../icons/checkmark-icon.svg)|
|**Global LB**|No|No|![Checkmark icon](../../icons/checkmark-icon.svg)|
{: row-headers}
