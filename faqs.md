...
## Does IBM Cloud Load Balancer support the HTTP/2 protocol?
{: #http2}
{: faq}
{: support}

Yes, as of March 31, 2023, IBM Cloud Load Balancer supports the HTTP/2 protocol for both HTTP requests and responses.
